...
export function AdminVehicleForm({ vehicle }: { vehicle?: Vehicle }) {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    const form = new FormData(event.currentTarget); const db = createClient(); const brand = String(form.get('brand')); const model = String(form.get('model')); const steeringType = String(form.get('steering_type') || '');
